        ...
        <div className="space-y-4">
          <div className="p-4 rounded-xl bg-slate-800/50 border border-slate-700">
            ...
            <div className="flex items-center gap-2">
              <div className="flex-1 h-2 bg-slate-700 rounded-full overflow-hidden">
                <div className="h-full w-3/4 bg-gradient-to-r from-violet-600 to-cyan-500"></div>
              </div>
          ...
          <div className="p-4 rounded-xl bg-slate-800/50 border border-slate-700">
            ...
            <button
              ...
              className="w-full px-4 py-2 bg-violet-600 hover:bg-violet-700 text-white rounded-lg transition font-medium text-sm mb-2"
            >
        ...
        <div className="p-6 rounded-xl bg-slate-800/50 border border-slate-700">
          ...
          {assets.length > 0 ? (
            ...
            <div className="text-center py-8 text-slate-400">
              ...
              <button onClick={() => setShowAddAsset(true)} className="px-4 py-2 bg-violet-600 hover:bg-violet-700 text-white rounded-lg transition font-medium text-sm">
